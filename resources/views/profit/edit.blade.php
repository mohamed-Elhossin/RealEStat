        ...
        <div class=" col-md-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <a href="{{ route('seller.index') }}" class="btn btn-primary my-3"> Back  <i class="fa-solid fa-hand-point-left"></i> </a>
                    @if ($errors->any())
                        ...
                        <div class="card-body">
                            <form action="{{ route('seller.update',$seller->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" value="{{$seller->name}}" name="name" placeholder="Seller Name"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <input type="text" value="{{$seller->salary}}" name="salary" placeholder="Seller salary "
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <input type="text"value="{{$seller->phone}}"  name="phone" placeholder="Phone"
                                        class="form-control">
                                </div>

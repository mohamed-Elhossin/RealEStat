        ...
        <div class=" col-md-6 max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <a href="{{ route('developer.index') }}" class="btn btn-primary my-3"> Back  <i class="fa-solid fa-hand-point-left"></i> </a>
                    @if ($errors->any())
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('developer.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" name="description" placeholder="Developer Description "
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <input type="text" name="rate" placeholder="Commission percentage"
                                        class="form-control">
                                </div>

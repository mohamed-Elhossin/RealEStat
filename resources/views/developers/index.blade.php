        ...
        <div class=" col-md-7 max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900">
                    <a href="{{ route('developer.create') }}" class="btn btn-primary my-3"> Add New <i
                        ...
                        <tbody>
                            @foreach ($developers as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->rate }} % </td>
                                    <td>
                                        <a href="{{ route('developer.edit', $item->id) }}"><i title="Edit"
                                                class="text-warning fa-solid fa-pen-to-square"></i></a>
                                    </td>
                                    <td>
                                        <a onclick="return confirm('Are You Sure')"
                                            href="{{ route('developer.destroy', $item->id) }}"><i title="Remove"
